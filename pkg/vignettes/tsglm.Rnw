...
\small
This document has been published as a vignette of the \proglang{R} package \pkg{tscount}. Last update: August~2016. An earlier version has been published as a discussion paper in February 2015 (\doi{10.17877/DE290R-7239}). A recent version has been conditionally accepted for publication in \emph{Journal of Statistical Software}. Please cite this manuscript as:\\[0.5em]
Tobias Liboschik, Konstantinos Fokianos \& Roland Fried (2016). ``tscount: An R Package for Analysis of Count Time Series Following Generalized Linear Models''. To appear in \emph{Journal of Statistical Software}.
}}
...
@
<<INLA-package2, include=FALSE, echo=FALSE, results=hide>>=
